...
import efd.FrameworkMod.FrameworkMod;

var ModObj:FrameworkMod;
...
function onLoad():Void { ModObj = new FrameworkMod(this); }

// Often called in pairs, deactivating and reactivating the mod as the criteria evaluation changes
// Due to the frequency of this occurring, these should be relatively light functions
